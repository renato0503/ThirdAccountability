...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        <h1 style="font-size: 20px; font-weight: 700; margin: 0;">Novo Projeto</h1>
        <p style="font-size: 13px; color: var(--text-muted); margin: 2px 0 0;">Preencha as informações para cadastrar um novo projeto</p>
    </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-4">
                            ...
                            {{-- Seletor de ano (visível apenas quando auto-gerar marcado) --}}
                            <div id="codigoAutoArea" class="mt-2" style="display: none;">
                                <div class="d-flex align-items-center gap-2">
                                    <label class="form-label mb-0" style="white-space: nowrap; font-size: 12.5px;">Ano:</label>
                                    <select id="anoCodigoSelect" class="form-select form-select-sm">
                                        @foreach($anos as $ano)
                                            <option value="{{ $ano }}" {{ $ano == $currentYear ? 'selected' : '' }}>
                                                {{ $ano }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            {{-- Inputs ocultos para controle de geração automática --}}
                            <input type="hidden" name="gerar_codigo" id="gerarCodigoHidden" value="0">
                            <input type="hidden" name="ano_codigo"   id="anoCodigoHidden"   value="{{ $currentYear }}">

                            {{-- Checkbox --}}
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" id="gerarCodigoCheck"
                                    {{ old('gerar_codigo') == '1' ? 'checked' : '' }}>
                                <label class="form-check-label" for="gerarCodigoCheck"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="numero_proposta" value="{{ old('numero_proposta') }}"
                            ...
                            <select name="institution_id"
                                ...
                                @foreach($institutions as $institution)
                                    <option value="{{ $institution->id }}"
                                        {{ old('institution_id', request('institution_id')) == $institution->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="funding_source_id"
                                ...
                                @foreach($fundingSources as $fs)
                                    <option value="{{ $fs->id }}"
                                        {{ old('funding_source_id') == $fs->id ? 'selected' : '' }}>
                                        {{ $fs->nome }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status"
                                ...
                                @foreach($statuses as $status)
                                    <option value="{{ $status }}"
                                        {{ old('status', 'RASCUNHO') == $status ? 'selected' : '' }}>
                                        {{ $status }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="parlamentar" value="{{ old('parlamentar') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="secretaria" id="secretariaSelect"
                                ...
                                <option value="Outro" {{ old('secretaria') == 'Outro' ? 'selected' : '' }}>
                                    Outro
                                </option>
                            </select>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="descricao" rows="3"
                                      ...
                                      placeholder="Descreva o objeto do projeto...">{{ old('descricao') }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="objetivo_geral" rows="2"
                                      ...
                                      placeholder="Qual o objetivo principal do projeto?">{{ old('objetivo_geral') }}</textarea>
                            @error('objetivo_geral')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        {{-- Objetivos Específicos (dinâmico) --}}
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="metodologia" rows="3"
                                      ...
                                      placeholder="Descreva a metodologia a ser utilizada...">{{ old('metodologia') }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="publico_alvo" rows="2"
                                      ...
                                      placeholder="Quem será beneficiado pelo projeto?">{{ old('publico_alvo') }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="justificativa" rows="2"
                                      ...
                                      placeholder="Por que este projeto é necessário?">{{ old('justificativa') }}</textarea>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-8">
                            ...
                            <textarea name="data_local_horario" rows="2"
                                      ...
                                      placeholder="Ex: 10/06/2025 — Centro Cultural — das 14h às 18h">{{ old('data_local_horario') }}</textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="quantidade_publico" value="{{ old('quantidade_publico') }}"
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="municipios_alcancados" rows="2"
                                      ...
                                      placeholder="Liste os municípios beneficiados pelo projeto">{{ old('municipios_alcancados') }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="descricao_servico" rows="3"
                                      ...
                                      placeholder="Descreva detalhadamente o serviço a ser executado">{{ old('descricao_servico') }}</textarea>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="capacidade_tecnica" rows="4"
                                      ...
                                      placeholder="Descreva a capacidade técnica e operacional da OSC para executar o projeto">{{ old('capacidade_tecnica') }}</textarea>
                            @error('capacidade_tecnica')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="col-12">
                            <label class="form-label">Fotos Comprobatórias <span style="color: var(--text-muted); font-weight: 400;">(até 5 fotos)</span></label>
                            <div class="row g-2">
                                @for($i = 0; $i < 5; $i++)
                                <div class="col-md-6">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="funcao_osc" rows="3"
                                      ...
                                      placeholder="Descreva o papel da OSC na execução do projeto">{{ old('funcao_osc') }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="recolhimento_impostos" rows="3"
                                      ...
                                      placeholder="Descreva os impostos a serem recolhidos (INSS, ISS, IRRF etc.)">{{ old('recolhimento_impostos') }}</textarea>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="riscos_identificados" rows="3"
                                      ...
                                      placeholder="Liste os riscos identificados para a execução do projeto">{{ old('riscos_identificados') }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="plano_mitigacao" rows="3"
                                      ...
                                      placeholder="Descreva as medidas para mitigar os riscos identificados">{{ old('plano_mitigacao') }}</textarea>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="resultados_esperados" rows="3"
                                      ...
                                      placeholder="Descreva os resultados esperados ao término do projeto">{{ old('resultados_esperados') }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="plano_divulgacao" rows="3"
                                      ...
                                      placeholder="Descreva como o projeto será divulgado (mídias, eventos, materiais)">{{ old('plano_divulgacao') }}</textarea>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="outrosPatrocinadoresCheck"
                                       ...
                                       {{ old('outros_patrocinadores') ? 'checked' : '' }}>
                        ...
                        <div class="col-12" id="quaisPatrocinadoresArea"
                             style="{{ old('outros_patrocinadores') ? '' : 'display: none;' }}">
                            ...
                            <textarea name="quais_patrocinadores" rows="3"
                                      ...
                                      placeholder="Liste os patrocinadores e apoiadores do projeto">{{ old('quais_patrocinadores') }}</textarea>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="text" name="nome_presidente" value="{{ old('nome_presidente') }}"
                        ...
                        <div class="col-12">
                            <label class="form-label">Imagem da Assinatura <span style="color: var(--text-muted); font-weight: 400;">(opcional)</span></label>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="valor_total" value="{{ old('valor_total') }}"
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary btn-lg">
                            <i class="bi bi-check-lg"></i> Criar Projeto
                        </button>
                        <a href="{{ route('projetos.index') }}" class="btn btn-outline-secondary">
                            Cancelar
                        </a>
...
(function () {
    ...
    // ── Código: alternar manual / automático ───────────────────────────────────
    var gerarCheck     = document.getElementById('gerarCodigoCheck');
    var codigoManual   = document.getElementById('codigoManual');
    var codigoAutoArea = document.getElementById('codigoAutoArea');
    var gerarHidden    = document.getElementById('gerarCodigoHidden');
    var anoHidden      = document.getElementById('anoCodigoHidden');
    var anoSelect      = document.getElementById('anoCodigoSelect');

    function toggleCodigo() {
        var auto = gerarCheck.checked;
        codigoManual.disabled   = auto;
        codigoAutoArea.style.display = auto ? '' : 'none';
        gerarHidden.value       = auto ? '1' : '0';
        if (auto) {
            codigoManual.value = '';
            anoHidden.value    = anoSelect ? anoSelect.value : '';
        }
    }

    if (gerarCheck) {
        gerarCheck.addEventListener('change', toggleCodigo);
        toggleCodigo(); // aplicar estado inicial (ex: após erro de validação)
    }

    if (anoSelect) {
        anoSelect.addEventListener('change', function () {
            anoHidden.value = this.value;
        });
    }
    ...
    // ── Locais de Execução ─────────────────────────────────────────────────────
    var locationIndex = 1; // índice 0 já renderizado via Blade
    ...
    window.removeLocation = function (btn) {
        ...
        if (list.querySelectorAll('.location-row').length > 1) {
            ...
            // Mantém ao menos uma linha, só limpa os valores
    ...
    var objectiveIndex = 1; // índice 0 já renderizado via Blade
    ...
    if (outrosCheck && quaisArea) {
        outrosCheck.addEventListener('change', function () {
            ...
            if (!this.checked) {
                var ta = quaisArea.querySelector('textarea');
                if (ta) ta.value = '';
            }
        });
    }

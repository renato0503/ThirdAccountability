...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        <h4 class="fw-bold mb-1">Novo Documento</h4>
        <p class="text-muted mb-0" style="font-size:13px">Cadastre e faça upload de um documento</p>
    </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" name="nome" value="{{ old('nome') }}" class="form-control" required placeholder="Ex: Contrato de Convênio 2024">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="validade" value="{{ old('validade') }}" class="form-control">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-text">PDF, Word, Excel, imagens ou ZIP. Máximo 20 MB.</div>
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-cloud-upload me-1"></i> Salvar Documento
                        </button>
